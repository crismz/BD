...
CREATE TABLE continent (
	...
	PercentTotalMass Decimal(10,2) NOT NULL DEFAULT '0',
	MostPopulousCity int NOT NULL DEFAULT '0',
	PRIMARY KEY(Name),
	FOREIGN KEY(MostPopulousCity)
		REFERENCES city(ID)
		ON DELETE CASCADE
);
...
INSERT INTO `continent` VALUES ('Oceania', 86000000, 5.9, 130);
INSERT INTO `continent` VALUES ('South America', 17840000, 12.0, 206);

# Ejercicio 6
ALTER TABLE country ADD CONSTRAINT fk_continent_name 
...
# Punto 11
/*
 * En countrylanguage la columna countryCode es redundante, 
 * se podria relacionar con el Code de country.
 */
